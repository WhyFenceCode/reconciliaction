...
export const articles: Record<number, { url: string; questionOne: string; questionTwo: string; questionThree: string; }> = {
    1001: {
        ...
        questionTwo: "In what ways are Indigenous people under represented in Canadian society?",
    ...
    1006: {
        url: "https://www.cbc.ca/news/politics/murray-sinclair-death-1.7372862",
        questionOne: "What were Murray Sinclair's contributions and how did these impact Indigenous Communities?",
        questionTwo: "What responses do you think communities had when Murray Sinclair became the first Indigenous judge in 1988?",
    ...
    1008: {
        ...
        questionOne: "What is the significance of art within Indigenous Communities?",
        questionTwo: "How can we create more representation of Indigenous artisist in the art community?",
